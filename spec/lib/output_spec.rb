...
RSpec.describe Output do
  ...
  context 'statement problem input 1 cart' do
    ...
    subject(:formatted_output) { Output.new(cart: cart).print_formatted }
    ...
    it 'must have the correct output result' do
      expect { formatted_output }.to output("2 book: 24.98 \n1 music CD: 16.49 \n1 chocolate bar: 0.85 \nSales Taxes: 1.50\nTotal: 42.32\n").to_stdout
    end
  end
  ...
  context 'statement problem input 3 cart' do
    ...
    it 'must have the correct output result' do
      expect { formatted_output }.to output("1 imported bottle of perfume: 32.19 \n1 bottle of perfume: 20.89 \n1 packet of headache pills: 9.75 \n3 imported boxes of chocolates: 35.55 \nSales Taxes: 7.90\nTotal: 98.38\n").to_stdout
    end
  end
end
